package com.qiniu.pili.droid.shortvideo.demo.faceunity;
...
import static com.qiniu.pili.droid.shortvideo.demo.faceunity.BeautyParameterModel.STR_FILTER_LEVEL;
import static com.qiniu.pili.droid.shortvideo.demo.faceunity.BeautyParameterModel.getValue;
import static com.qiniu.pili.droid.shortvideo.demo.faceunity.BeautyParameterModel.isHeightPerformance;
import static com.qiniu.pili.droid.shortvideo.demo.faceunity.BeautyParameterModel.isOpen;
import static com.qiniu.pili.droid.shortvideo.demo.faceunity.BeautyParameterModel.sFilterLevel;
import static com.qiniu.pili.droid.shortvideo.demo.faceunity.BeautyParameterModel.sFilterName;
import static com.qiniu.pili.droid.shortvideo.demo.faceunity.BeautyParameterModel.sHairLevel;
import static com.qiniu.pili.droid.shortvideo.demo.faceunity.BeautyParameterModel.sHeavyBlur;
import static com.qiniu.pili.droid.shortvideo.demo.faceunity.BeautyParameterModel.sSkinDetect;
import static com.qiniu.pili.droid.shortvideo.demo.faceunity.BeautyParameterModel.setValue;
...
public class BeautyControlView extends FrameLayout {
    ...
    private void initAnimojiView() {
        ...
        mRvAnim.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void initCartoonView() {
        ...
        mRvCartoonFilter.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void initHairView() {
        ...
        mRvHair.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void initArMask() {
        ...
        mRvArMask.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void initGesture() {
        ...
        mRvGesture.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void initNormalEffect() {
        ...
        mRvEffectNormal.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void initExpression() {
        ...
        mRvExpression.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void initHahaMirror() {
        ...
        mRvHahaMirror.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void initFaceChange() {
        ...
        mRvFaceChange.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void initBackground() {
        ...
        mRvBackground.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void initPortraitDrive() {
        ...
        mRvPortraitDrive.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void initViewTop() {
        ...
        mBeautySeekBar.setOnProgressChangeListener(new DiscreteSeekBar.OnSimpleProgressChangeListener() {
            ...
            public void onProgressChanged(DiscreteSeekBar SeekBar, int value, boolean fromUser) {
                ...
                } else if (checkedCheckBoxId == R.id.beauty_ratio_hair) {
                    if (mOnFUControlListener == null) {
                        return;
                    }
    ...
    private void clickViewBottomRadio(int viewId) {
        ...
        } else if (viewId == R.id.beauty_ratio_animoji) {
            mRvAnim.setVisibility(VISIBLE);
        } else if (viewId == R.id.beauty_ratio_cartoon_filter) {
            mRvCartoonFilter.setVisibility(VISIBLE);
        } else if (viewId == R.id.beauty_ratio_hair) {
            mRvHair.setVisibility(VISIBLE);
        } else if (viewId == R.id.beauty_ratio_ar_mask) {
            mRvArMask.setVisibility(VISIBLE);
        } else if (viewId == R.id.beauty_ratio_gesture_effect) {
            mRvGesture.setVisibility(VISIBLE);
        } else if (viewId == R.id.beauty_ratio_normal) {
            mRvEffectNormal.setVisibility(VISIBLE);
        } else if (viewId == R.id.beauty_ratio_expression) {
            mRvExpression.setVisibility(VISIBLE);
        } else if (viewId == R.id.beauty_ratio_haha_mirror) {
            mRvHahaMirror.setVisibility(VISIBLE);
        } else if (viewId == R.id.beauty_ratio_background) {
            mRvBackground.setVisibility(VISIBLE);
        } else if (viewId == R.id.beauty_ratio_face_change) {
            mRvFaceChange.setVisibility(VISIBLE);
        } else if (viewId == R.id.beauty_ratio_portrait_drive) {
        ...
        public void onBindViewHolder(@NonNull HairAdapter.HomeRecyclerHolder holder, int position) {
            ...
            holder.effectImg.setOnClickListener(new OnMultiClickListener() {
                ...
                protected void onMultiClick(View v) {
                    ...
                    Log.i(TAG, "onClick: hairIndex:" + hairIndex + ", hairLevel:" + hairLevel +
