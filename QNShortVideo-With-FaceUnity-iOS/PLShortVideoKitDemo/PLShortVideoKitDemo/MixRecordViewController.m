...
- (void)setupvideoMixRecorder {
    ...
    self.videoConfiguration.videoSize = CGSizeMake(1080, 960);
    self.videoConfiguration.averageVideoBitRate = 1024*4000;
    self.videoConfiguration.cameraVideoFrame = CGRectMake(0, 0, 540, 960);
    self.videoConfiguration.sampleVideoFrame = CGRectMake(540, 0, 540, 960);
